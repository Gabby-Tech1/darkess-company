    ...
    <div>
      ...
      <div className="md:h-[60vh] h-[70vw] flex items-center justify-center w-screen">
        ...
        <div className="absolute">
          <div className="text-white flex flex-col items-center justify-center" data-aos="fade-up">
            <h1 className="text-5xl font-bold">Our Services</h1>
            <p className="md:text-xl text-center md:px-32 px-4">
              At Dakess Drilling and Construction Limited, we offer a comprehensive range of services to meet your infrastructure needs.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-10 flex flex-col gap-10 lg:mx-44 px-4">
        <h1 className="text-2xl text-center" data-aos="fade-down">We offer the following services</h1>
        <div className='py-8 flex flex-col gap-10'>
          ...
          <div className='flex flex-col md:flex-row-reverse items-center justify-between gap-10' data-aos="fade-left">
            <div className="flex flex-col gap-3">
            ...
            <Image src={Founder2} alt="Founder2" width={400} height={450} />
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 py-6 px-10 md:px-24">
        <div className="bg-blue text-white shadow-lg rounded-lg overflow-hidden cursor-pointer hover:scale-y-110 duration-300 ease-linear"  data-aos="zoom-in">
          <div className="p-6">
      ...
      <div className="md:h-[60vh] h-[70vw] flex items-center justify-center w-screen">
        ...
        />
        <div className="absolute">
          <div className="text-white text-center flex" data-aos="fade-up">
