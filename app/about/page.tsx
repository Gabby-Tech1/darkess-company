...
const About = () => {
  return (
    <div>
        <div className="h-[60vh] flex items-center justify-center w-screen">
        ...
        <div className="py-10 flex flex-col gap-10">
            <div className='flex flex-col items-center'>
                ...
                <p className='text-blue text-4xl '>Dakess Drilling And Construction Limited</p>
                <p className='text-center px-44'>At Dakess Drilling and Construction Limited, we are a leading provider of expert drilling and construction services, dedicated to delivering high-quality solutions to our clients. With a strong commitment to safety, innovation, and customer satisfaction, we have established ourselves as a trusted partner in the industry.</p>
            </div>
            <div className='flex items-center justify-center gap-20 mx-44'>
        ...
        <div className='bg-blue rounded-md text-center flex flex-col items-center gap-4 p-20 mx-44 text-white my-8'>
        ...
        <div className='flex flex-col items-center gap-4 py-12 px-44'>
            <h1 className='text-3xl text-blue'>Our Values</h1>
            <div className='grid grid-cols-2 gap-16 border-2 border-blue p-16'>
                <div className='flex flex-col gap-2'>
                    <h1 className='text-2xl text-blue font-semibold'>SAFETY</h1>
                    <p>We prioritize the well-being of our employees, clients, and the environment</p>
                </div>
                <div className='flex flex-col gap-2'>
                    <h1 className='text-2xl text-blue font-semibold'>QUALITY</h1>
                    <p>We deliver exceptional results, meeting and exceeding industry standards</p>
                </div>
                <div className='flex flex-col gap-2'>
                    <h1 className='text-2xl text-blue font-semibold'>INNOVATION</h1>
                    <p>We embrace new technologies and methods to improve efficiency and effectiveness.</p>
                </div>
                <div className='flex flex-col gap-2'>
                    <h1 className='text-2xl text-blue font-semibold'>CUSTOMER SATISFACTION</h1>
